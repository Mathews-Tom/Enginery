"""Source-bound terminal evidence for the Stage 1 merge-ready claim."""
...
class Stage1EvidenceBundle:
    """Immutable evidence whose terminal claim binds exact source and PR revisions."""
    ...
    def current_for(self, *, issue_revision: str, base_revision: str, head_revision: str) -> bool:
        """Return whether every external subject still matches this evidence."""
        return (
            issue_revision == self.issue_revision
