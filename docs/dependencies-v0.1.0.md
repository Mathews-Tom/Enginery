...
`v0.1.0` release; full pinned versions and per-platform `sha256` wheel/sdist
...
clean `v0.1.0` install (`uv pip install -e ".[armory]"`) in an isolated
virtual environment:

| Name         | Version | License                    | URL                                                 |
|--------------|---------|----------------------------|------------------------------------------------------|
| enginery     | 0.1.0   | Apache-2.0                 | https://github.com/Mathews-Tom/Enginery              |
